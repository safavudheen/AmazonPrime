    ...
    return (
        ...
        <Container className="themed-container" fluid={true}>
           ...
           <div className='navbar1' >
               ...
               < Col  md='5' className='d-md-block d-sm-none d-none'>
               <div className='btnclass'>
                  
                   <button className='btnPrime'> Prime Video  </button>
                ...
                <Col md='2' xm='0' className='d-md-block d-sm-none d-none'>
                <div className='hdr1'>
                   <h1 className='hdr1'>Prime Now </h1>
               </div>
               </Col>
                <Col md='2' className="d-md-block d-sm-none d-none">
               <div className='hdr2'>
                   <h1 className='hdr2'>Get Ultrafast delivery</h1>
               </div>
               </Col>
               </Row>
           </div>
